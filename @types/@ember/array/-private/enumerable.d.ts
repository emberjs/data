...
interface Enumerable<T> {
   ...
   */
  setEach(key: string, value: unknown): unknown;
  /**
   ...
   */
  reject(callbackfn: (value: T, index: number, array: T[]) => unknown, thisArg?: unknown): NativeArray<T>;
  /**
