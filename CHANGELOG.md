...
## Release 3.15.0-beta.0 (November 6, 2019)
- [#6554](https://github.com/emberjs/data/pull/6554) [CHORE] pushPayload test for serializer encapsulation side quest (#6554)
- [#6501](https://github.com/emberjs/data/pull/6501) [CHORE] sync dev dependencies again (#6501)
- [#6472](https://github.com/emberjs/data/pull/6472) Use GitHub Actions for CI (#6472)
...
- [#6485](https://github.com/emberjs/data/pull/6485) [CHORE] Use `ember-data` without `@ember-data/debug` (#6485)
...
- [22f7af03](https://github.com/emberjs/data/commit/22f7af034acfce9cee6b081d7134e81f9c9d724c) [FIX] only include version in ember-data output (#6528)
- [#6478](https://github.com/emberjs/data/pull/6478) [CHORE]: move Model and related to @ember-data/model (#6478)
...
- [#6532](https://github.com/emberjs/data/pull/6532) [CHORE] Fail CI build if `yarn.lock` is out of date (#6532)
- [#6517](https://github.com/emberjs/data/pull/6517) Replace Travis CI badge with GitHub CI badge (#6517)
- [#6526](https://github.com/emberjs/data/pull/6526) [CHORE] Configure @typescript-eslint for linting TypeScript files (#6526)
- [#6513](https://github.com/emberjs/data/pull/6513) [CHORE] redivide assets to move record-data into package (#6513)
- [#6531](https://github.com/emberjs/data/pull/6531)  [TEST] Get a simple fastboot smoke test working (#6531)
- [#6521](https://github.com/emberjs/data/pull/6521) [CHORE] fully encapsulate adapter package (#6521)
- [#6525](https://github.com/emberjs/data/pull/6525) [CHORE] moving files into Debug package (#6525)
- [#6508](https://github.com/emberjs/data/pull/6508) [CHORE] scaffold debug and record-data packages (#6508)
- [#6606](https://github.com/emberjs/data/pull/6606) [FEAT links] ensures full links object support for relationships (#6606)
- [#6551](https://github.com/emberjs/data/pull/6551) [CHORE ci] Add Ember LTS 3.12 to GitHub Actions test matrix (#6551)
- [#6550](https://github.com/emberjs/data/pull/6550) [TEST] normalize test for serializer encapsulation side quest (#6550)
- [#6533](https://github.com/emberjs/data/pull/6533) [CHORE] Cleanup ESLint config (#6533)
- [#6547](https://github.com/emberjs/data/pull/6547) chore(ci): Remove Azure Pipelines configuration (#6547)
- [#6539](https://github.com/emberjs/data/pull/6539) [TEST] serialize test for serializer encapsulation side quest (#6539)
...
- [#6627](https://github.com/emberjs/data/pull/6627) [CHORE] allow asserting all tests for deprecations (#6627)
- [#6587](https://github.com/emberjs/data/pull/6587) fix AdapterError reexport (#6587)
- [#6582](https://github.com/emberjs/data/pull/6582) Revert "chore(ci): Remove Azure Pipelines configuration" (#6582)
- [#6568](https://github.com/emberjs/data/pull/6568) [BUGFIX release] Enable `store.createRecord` in FastBoot (#6568)
- [#6552](https://github.com/emberjs/data/pull/6552) [CHORE] Remove ember-cli-htmlbars-inline-precompile (#6552)
- [#6661](https://github.com/emberjs/data/pull/6661) [DOC] Close code block in the description
...
- [#6612](https://github.com/emberjs/data/pull/6612) [CHORE]: Refactor integration/adapter/find-test.js (#6612)
- [#6592](https://github.com/emberjs/data/pull/6592) chore(ci): Increase browser start timeout (#6592)
- [#6628](https://github.com/emberjs/data/pull/6628) [CHORE] test fixes for deprecations, enables asserting all deprecations (#6628)
- [#6635](https://github.com/emberjs/data/pull/6635) [CHORE] fix Typo (#6635)
- [#6641](https://github.com/emberjs/data/pull/6641) [CHORE] re-organizes packages to clarify when unpublished/priva… (#6641)
...
- [#6655](https://github.com/emberjs/data/pull/6655) [CHORE] adds asset reporting infra (#6655)
