...
import { Relationship } from './cache/relationship';
import { ValidationError } from './cache/validation-error';
...
export interface Cache {
   ...
   * @public
   */
  hydrate(stream: ReadableStream<unknown>): void;
   ...
   */
  getRelationship(identifier: StableRecordIdentifier, field: string): Relationship;
