 ...
 */
import type { QueryParamsSerializationOptions } from '@ember-data/request-utils';
...
type ImmutableRequestOptions<T> = Readonly<T> & {
...
export type ImmutableDeleteRequestOptions = ImmutableRequestOptions<DeleteRequestOptions>;
export type ImmutableUpdateRequestOptions = ImmutableRequestOptions<UpdateRequestOptions>;
export type ImmutableCreateRequestOptions = ImmutableRequestOptions<CreateRequestOptions>;
