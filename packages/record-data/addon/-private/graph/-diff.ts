...
export function computeLocalState(storage: CollectionRelationship): StableRecordIdentifier[] {
  if (!storage.isDirty) {
...
export function updateRemoteState(storage: Storage, newState: StableRecordIdentifier[]) {}
