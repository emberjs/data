...
test("creating a record with a 422 error marks the records as invalid", function(){
  ...
  deepEqual(person.get('errors.name.firstObject.message'), "can't be blank", "the person has the errors");
});
...
test("updating a record with a 422 error marks the records as invalid", function(){
  ...
  deepEqual(person.get('errors.name.firstObject.message'), "can't be blank", "the person has the errors");
  deepEqual(person.get('errors.updatedAt.firstObject.message'), "can't be blank", "the person has the errors");
});
