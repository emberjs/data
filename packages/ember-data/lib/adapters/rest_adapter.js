...
DS.RESTAdapter = DS.Adapter.extend({
  /**
    This method is called by the store in order to fetch the JSON for a given
    type and ID.
  ...
  */
  ...
  /**
    This method is called by the store in order to fetch a JSON array for all
  ...
  */
  ...
  /**
    This method is called by the store in order to fetch a JSON array for
  ...
  */
  ...
  /**
    This method is called by the store when a newly created record is
    `save`d.
  ...
  */
  ...
  /**
    This method is called by the store when an existing record is `save`d.
  ...
  */
  ...
  /**
    This method is called by the store when an deleted record is `save`d.
  ...
  */
  ...
  /**
    This method builds a URL for a given type and optional ID.
  ...
  */
  ...
  /**
    This method is called when the server has returned a payload representing
  ...
  */
  ...
  /**
    This method normalizes a part of the JSON payload returned by
  ...
  */
  ...
  /**
    This method takes a URL, an HTTP method and a hash of data, and makes an
    HTTP request.
