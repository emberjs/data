...
DS.RESTAdapter = DS.Adapter.extend({
  ...
  */
  ...
  /**
    ...
    It serializes the record, and performs HTTP `PUT` to a URL generated by `buildURL`.
  ...
  */
  ...
  /**
    ...
    It serializes the record, and performs HTTP `DELETE` to a URL generated by `buildURL`.
