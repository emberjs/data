...
export default {
  ...
  DEPRECATE_PROMISE_MANY_ARRAY_BEHAVIORS: '4.8',
  DEPRECATE_V1CACHE_STORE_APIS: '4.8',
  DEPRECATE_RELATIONSHIPS_WITHOUT_TYPE: '4.8',
  DEPRECATE_RELATIONSHIPS_WITHOUT_ASYNC: '4.8',
  DEPRECATE_RELATIONSHIPS_WITHOUT_INVERSE: '4.8',
  DEPRECATE_V1_RECORD_DATA: '4.8',
  DEPRECATE_A_USAGE: '4.8',
  ...
  DEPRECATE_NON_UNIQUE_PAYLOADS: '4.8',
};
