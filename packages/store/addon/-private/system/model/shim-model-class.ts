...
export default class ShimModelClass {
  ...
  constructor(private __store: CoreStore, public modelName: string, private __id?: string) {}

  get fields(): Map<string, 'attribute' | 'belongsTo' | 'hasMany'> {
    let attrs = this.__store._attributesDefinitionFor(this.modelName, this.__id);
