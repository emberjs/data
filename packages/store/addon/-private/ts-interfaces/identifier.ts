...
export type ResourceData<T extends string = string> = ResourceIdentifierObject<T> | ExistingResourceObject<T>;
...
/**
  ...
  @static
*/
export type GenerationMethod = <T extends string>(
  data: ResourceData<T> | { type: string },
...
export type UpdateMethod = {
  <T extends string>(identifier: StableRecordIdentifier<T>, newData: ResourceData<T>, bucket: 'record'): void;
...
/**
 ...
 from any secondary lookup tables or caches that the user has populated for it.
  ...
  @static
*/
export type ForgetMethod = <T extends string>(
  identifier: StableIdentifier | StableRecordIdentifier<T>,
  bucket: IdentifierBucket
) => void;
