...
type Backburner = import('@ember/runloop/-private/backburner').default;
type EmberRunTimer = import('@ember/runloop/types').EmberRunTimer;

type EmberRunQueues = import('@ember/runloop/-private/types').EmberRunQueues;
type RunMethod<K, V> = import('@ember/runloop/-private/types').RunMethod<K, V>;
...
export interface RunNamespace {
  ...
  next(method: () => void, ...args: any[]): EmberRunTimer;
