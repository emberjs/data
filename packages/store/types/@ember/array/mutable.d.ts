...
interface MutableArray<T> extends EmberArray<T>, MutableEnumerable<T> {
   ...
   */
  replace(idx: number, amt: number, objects?: T[] | null): void;
  /**
   ...
   */
  pushObjects(objects: T[] | Enumerable<T>): this;
  /**
   ...
   */
  unshiftObjects(objects: T[] | Enumerable<T>): this;
  /**
   ...
   */
  setObjects(objects: T[] | EmberArray<T>): this;
}
