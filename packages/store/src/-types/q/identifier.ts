...
/**
 ...
 If `id` has not previously existed, it will be assigned to the `Identifier`
  ...
  @static
*/
export type UpdateMethod = (identifier: ResourceCacheKey, newData: unknown, bucket: 'record') => void;
...
/**
 ...
 from any secondary lookup tables or caches that the user has populated for it.
  ...
  @static
*/
export type ForgetMethod = (identifier: ResourceCacheKey, bucket: IdentifierBucket) => void;
...
export type KeyInfoMethod = (resource: unknown, known: ResourceCacheKey | null) => KeyInfo;
