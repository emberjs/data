...
export interface BuildURLMixin<R extends ResolvedRegistry = DefaultRegistry> {
...
export interface MixtBuildURLMixin<R extends ResolvedRegistry> extends BuildURLMixin<R> {
  host: string | null;
