  ...
  bad: [
    // Request with content block but no yielded parameters
    {
      ...
      result: {
        ...
        line: 1,
        column: 0,
        source: '<Request @request={{@request}}><:content>Hello World</:content></Request>',
      },
    },
    ...
    // Request with content block yielding result but not using it
    {
      ...
      result: {
        rule: 'always-use-request-content',
        message:
          "The <Request> component's content block yields a result parameter 'result' that is not used within the block",
        line: 1,
        column: 0,
        source: '<Request @request={{@request}}><:content as |result|>Hello World</:content></Request>',
      },
    },
    ...
    // Request with content block yielding result and state but using neither
    {
      ...
      result: {
        ...
        line: 1,
        column: 0,
        source: '<Request @request={{@request}}><:content as |result state|>Hello World</:content></Request>',
      },
    },
    ...
    // Request with content block yielding with different name but not using it
    {
      ...
      result: {
        rule: 'always-use-request-content',
        message:
          "The <Request> component's content block yields a result parameter 'data' that is not used within the block",
        line: 1,
        column: 0,
        source: '<Request @request={{@request}}><:content as |data|>Hello World</:content></Request>',
      },
    },
    ...
    // Request with no content block and no other blocks
    {
      ...
      result: {
        ...
        line: 1,
        column: 0,
        source: '<Request @request={{@request}}>Hello World</Request>',
      },
    },
