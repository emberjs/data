...
import type { CollectionEdge, ResourceEdge, Graph, GraphEdge, UpgradedMeta } from '@ember-data/graph/-private';
...
import { TypeFromInstanceOrString } from '@warp-drive/core-types/record';
...
export class LegacySupport {
  ...
  _syncArray(array: LiveArray<unknown>) {
