...
function notifyRelationship(identifier: ResourceCacheKey, key: string, record: Model, meta: RelationshipSchema) {
...
function notifyAttribute(store: Store, identifier: ResourceCacheKey, key: string, record: Model) {
