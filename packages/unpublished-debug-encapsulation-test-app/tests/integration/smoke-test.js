...
module('Debug Encapsulation - Smoke Tests', function (hooks) {
  setupTest(hooks);

  test('No @ember-data/debug modules are present', function (assert) {
    assertPackageNotPresent('@ember-data/debug', assert);
  });
