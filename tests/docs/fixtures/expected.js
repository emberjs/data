module.exports = {
  ...
  classitems: [
    ...
    '(private) @ember-data/store LiveArray#store',
    ...
    '(public) @ember-data/store LiveArray#isUpdating',
    '(public) @ember-data/store LiveArray#save',
    '(public) @ember-data/store LiveArray#update',
