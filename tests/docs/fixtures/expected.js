module.exports = {
  ...
  classes: [
    ...
    '(public) @ember-data/store PromiseArray',
    '(public) @ember-data/store PromiseObject',
  ...
  classitems: [
    ...
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_A_USAGE',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_ARRAY_LIKE',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_COMPUTED_CHAINS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_EARLY_STATIC',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_EMBER_INFLECTOR',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_HAS_RECORD',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_HELPERS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_JSON_API_FALLBACK',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_MANY_ARRAY_DUPLICATES',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_MODEL_REOPEN',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_NON_EXPLICIT_POLYMORPHISM',
    ...
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_PROMISE_MANY_ARRAY_BEHAVIORS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_PROMISE_PROXIES',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_RELATIONSHIP_REMOTE_UPDATE_CLEARING_LOCAL_STATE',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_RELATIONSHIPS_WITHOUT_ASYNC',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_RELATIONSHIPS_WITHOUT_INVERSE',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_RELATIONSHIPS_WITHOUT_TYPE',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_RSVP_PROMISE',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_SAVE_PROMISE_ACCESS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_SNAPSHOT_MODEL_CLASS_ACCESS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_STORE_EXTENDS_EMBER_OBJECT',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_STORE_FIND',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_STRING_ARG_SCHEMAS',
    '(public) @warp-drive/build-config CurrentDeprecations#DISABLE_6X_DEPRECATIONS',
