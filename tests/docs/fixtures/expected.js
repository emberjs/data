module.exports = {
  ...
  classitems: [
    ...
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_V1_RECORD_DATA',
    ...
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_RELATIONSHIPS_WITHOUT_INVERSE',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_RELATIONSHIPS_WITHOUT_TYPE',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_RSVP_PROMISE',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_SAVE_PROMISE_ACCESS',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_SNAPSHOT_MODEL_CLASS_ACCESS',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_STORE_FIND',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_STRING_ARG_SCHEMAS',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_V1CACHE_STORE_APIS',
    '(public) @ember-data/deprecations CurrentDeprecations#DEPRECATE_MANY_ARRAY_DUPLICATES_4_12',
    ...
    '(public) @ember-data/store CacheManager#getBelongsTo',
    '(public) @ember-data/store CacheManager#getErrors',
    '(public) @ember-data/store CacheManager#getHasMany',
    '(public) @ember-data/store CacheManager#getRelationship',
    '(public) @ember-data/store CacheManager#getResourceIdentifier',
    '(public) @ember-data/store CacheManager#hasChangedAttributes',
    ...
    '(public) @ember-data/store CacheManager#setDirtyAttribute',
    '(public) @ember-data/store CacheManager#setDirtyBelongsTo',
    '(public) @ember-data/store CacheManager#setDirtyHasMany',
    ...
    '(public) @ember-data/store CacheStoreWrapper#attributesDefinitionFor',
    '(public) @ember-data/store CacheStoreWrapper#disconnectRecord',
    '(public) @ember-data/store CacheStoreWrapper#getSchemaDefinitionService',
    '(public) @ember-data/store CacheStoreWrapper#hasRecord',
    '(public) @ember-data/store CacheStoreWrapper#identifierCache',
    '(public) @ember-data/store CacheStoreWrapper#isRecordInUse',
    '(public) @ember-data/store CacheStoreWrapper#notifyBelongsToChange',
    '(public) @ember-data/store CacheStoreWrapper#notifyChange',
    '(public) @ember-data/store CacheStoreWrapper#notifyErrorsChange',
    '(public) @ember-data/store CacheStoreWrapper#notifyHasManyChange',
    '(public) @ember-data/store CacheStoreWrapper#notifyPropertyChange',
    '(public) @ember-data/store CacheStoreWrapper#notifyStateChange',
    '(public) @ember-data/store CacheStoreWrapper#recordDataFor',
    '(public) @ember-data/store CacheStoreWrapper#relationshipsDefinitionFor',
    '(public) @ember-data/store CacheStoreWrapper#setRecordId',
    ...
    '(public) @ember-data/store SchemaService#relationshipsDefinitionFor',
