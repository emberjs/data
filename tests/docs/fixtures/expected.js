module.exports = {
  ...
  classes: [
    ...
    '(public) @warp-drive/core-types/fields <Type> ArrayField',
    '(public) @warp-drive/core-types/fields <Type> CollectionField',
    '(public) @warp-drive/core-types/fields <Type> DerivedField',
    '(public) @warp-drive/core-types/fields <Type> FieldSchema',
    '(public) @warp-drive/core-types/fields <Type> GenericField',
    '(public) @warp-drive/core-types/fields <Type> HashField',
    '(public) @warp-drive/core-types/fields <Type> IdentityField',
    '(public) @warp-drive/core-types/fields <Type> LegacyAliasField',
    '(public) @warp-drive/core-types/fields <Type> LegacyAttributeField',
    '(public) @warp-drive/core-types/fields <Type> LegacyBelongsToField',
    '(public) @warp-drive/core-types/fields <Type> LegacyHasManyField',
    '(public) @warp-drive/core-types/fields <Type> LegacyModeFieldSchema',
    '(public) @warp-drive/core-types/fields <Type> LegacyResourceSchema',
    '(public) @warp-drive/core-types/fields <Type> LinksModeBelongsToField',
    '(public) @warp-drive/core-types/fields <Type> LinksModeHasManyField',
    '(public) @warp-drive/core-types/fields <Type> LocalField',
    '(public) @warp-drive/core-types/fields <Type> ObjectAliasField',
    '(public) @warp-drive/core-types/fields <Type> ObjectField',
    '(public) @warp-drive/core-types/fields <Type> ObjectFieldSchema',
    '(public) @warp-drive/core-types/fields <Type> ObjectSchema',
    '(public) @warp-drive/core-types/fields <Type> PolarisAliasField',
    '(public) @warp-drive/core-types/fields <Type> PolarisModeFieldSchema',
    '(public) @warp-drive/core-types/fields <Type> PolarisResourceSchema',
    '(public) @warp-drive/core-types/fields <Type> ResourceField',
    '(public) @warp-drive/core-types/fields <Type> SchemaArrayField',
    '(public) @warp-drive/core-types/fields <Type> SchemaObjectField',
  ...
  classitems: [
    '(public) @warp-drive/core-types/fields <Type> LegacyResourceSchema#fields',
    '(public) @warp-drive/core-types/fields <Type> LegacyResourceSchema#identity',
    '(public) @warp-drive/core-types/fields <Type> LegacyResourceSchema#legacy',
    '(public) @warp-drive/core-types/fields <Type> LegacyResourceSchema#traits',
    '(public) @warp-drive/core-types/fields <Type> LegacyResourceSchema#type',
    '(public) @warp-drive/core-types/fields <Type> ObjectSchema#fields',
    '(public) @warp-drive/core-types/fields <Type> ObjectSchema#identity',
    '(public) @warp-drive/core-types/fields <Type> ObjectSchema#type',
    '(public) @warp-drive/core-types/fields <Type> PolarisResourceSchema#fields',
    '(public) @warp-drive/core-types/fields <Type> PolarisResourceSchema#identity',
    '(public) @warp-drive/core-types/fields <Type> PolarisResourceSchema#traits',
    '(public) @warp-drive/core-types/fields <Type> PolarisResourceSchema#type',
    '(public) @warp-drive/core-types/fields <Type> GenericField#kind',
    '(public) @warp-drive/core-types/fields <Type> GenericField#name',
    '(public) @warp-drive/core-types/fields <Type> GenericField#options',
    '(public) @warp-drive/core-types/fields <Type> GenericField#type',
    ...
    '(public) @warp-drive/build-config DebugLogging#LOG_MUTATIONS',
    '(public) @warp-drive/build-config DebugLogging#LOG_NOTIFICATIONS',
    '(public) @warp-drive/build-config DebugLogging#LOG_OPERATIONS',
    '(public) @warp-drive/build-config DebugLogging#LOG_PAYLOADS',
    ...
    '(public) @warp-drive/core-types/fields <Type> ArrayField#kind',
    '(public) @warp-drive/core-types/fields <Type> ArrayField#name',
    '(public) @warp-drive/core-types/fields <Type> ArrayField#type',
    '(public) @warp-drive/core-types/fields <Type> CollectionField#kind',
    '(public) @warp-drive/core-types/fields <Type> CollectionField#name',
    '(public) @warp-drive/core-types/fields <Type> CollectionField#type',
    '(public) @warp-drive/core-types/fields <Type> DerivedField#kind',
    '(public) @warp-drive/core-types/fields <Type> DerivedField#name',
    '(public) @warp-drive/core-types/fields <Type> DerivedField#type',
    '(public) @warp-drive/core-types/fields <Type> HashField#kind',
    '(public) @warp-drive/core-types/fields <Type> HashField#name',
    '(public) @warp-drive/core-types/fields <Type> HashField#type',
    '(public) @warp-drive/core-types/fields <Type> IdentityField#kind',
    '(public) @warp-drive/core-types/fields <Type> IdentityField#name',
    '(public) @warp-drive/core-types/fields <Type> LegacyAliasField#kind',
    '(public) @warp-drive/core-types/fields <Type> LegacyAliasField#name',
    '(public) @warp-drive/core-types/fields <Type> LegacyAliasField#type',
    '(public) @warp-drive/core-types/fields <Type> LegacyAttributeField#kind',
    '(public) @warp-drive/core-types/fields <Type> LegacyAttributeField#name',
    '(public) @warp-drive/core-types/fields <Type> LegacyAttributeField#type',
    '(public) @warp-drive/core-types/fields <Type> LegacyBelongsToField#kind',
    '(public) @warp-drive/core-types/fields <Type> LegacyBelongsToField#name',
    '(public) @warp-drive/core-types/fields <Type> LegacyBelongsToField#type',
    '(public) @warp-drive/core-types/fields <Type> LegacyHasManyField#kind',
    '(public) @warp-drive/core-types/fields <Type> LegacyHasManyField#name',
    '(public) @warp-drive/core-types/fields <Type> LegacyHasManyField#type',
    '(public) @warp-drive/core-types/fields <Type> LinksModeBelongsToField#kind',
    '(public) @warp-drive/core-types/fields <Type> LinksModeBelongsToField#name',
    '(public) @warp-drive/core-types/fields <Type> LinksModeBelongsToField#type',
    '(public) @warp-drive/core-types/fields <Type> LinksModeHasManyField#kind',
    '(public) @warp-drive/core-types/fields <Type> LinksModeHasManyField#name',
    '(public) @warp-drive/core-types/fields <Type> LinksModeHasManyField#type',
    '(public) @warp-drive/core-types/fields <Type> LocalField#kind',
    '(public) @warp-drive/core-types/fields <Type> LocalField#name',
    '(public) @warp-drive/core-types/fields <Type> LocalField#type',
    '(public) @warp-drive/core-types/fields <Type> ObjectAliasField#kind',
    '(public) @warp-drive/core-types/fields <Type> ObjectAliasField#name',
    '(public) @warp-drive/core-types/fields <Type> ObjectAliasField#type',
    '(public) @warp-drive/core-types/fields <Type> ObjectField#kind',
    '(public) @warp-drive/core-types/fields <Type> ObjectField#name',
    '(public) @warp-drive/core-types/fields <Type> ObjectField#type',
    '(public) @warp-drive/core-types/fields <Type> PolarisAliasField#kind',
    '(public) @warp-drive/core-types/fields <Type> PolarisAliasField#name',
    '(public) @warp-drive/core-types/fields <Type> PolarisAliasField#type',
    '(public) @warp-drive/core-types/fields <Type> ResourceField#kind',
    '(public) @warp-drive/core-types/fields <Type> ResourceField#name',
    '(public) @warp-drive/core-types/fields <Type> ResourceField#type',
    '(public) @warp-drive/core-types/fields <Type> SchemaArrayField#kind',
    '(public) @warp-drive/core-types/fields <Type> SchemaArrayField#name',
    '(public) @warp-drive/core-types/fields <Type> SchemaArrayField#type',
    '(public) @warp-drive/core-types/fields <Type> SchemaObjectField#kind',
    '(public) @warp-drive/core-types/fields <Type> SchemaObjectField#name',
    '(public) @warp-drive/core-types/fields <Type> SchemaObjectField#type',
    '(public) @warp-drive/core-types/fields <Type> ArrayField#options',
    '(public) @warp-drive/core-types/fields <Type> DerivedField#options',
    '(public) @warp-drive/core-types/fields <Type> HashField#options',
    '(public) @warp-drive/core-types/fields <Type> LegacyAliasField#options',
    '(public) @warp-drive/core-types/fields <Type> LocalField#options',
    '(public) @warp-drive/core-types/fields <Type> ObjectAliasField#options',
    '(public) @warp-drive/core-types/fields <Type> ObjectField#options',
    '(public) @warp-drive/core-types/fields <Type> PolarisAliasField#options',
    '(public) @warp-drive/core-types/fields <Type> ResourceField#options',
    '(public) @warp-drive/core-types/fields <Type> SchemaArrayField#options',
    '(public) @warp-drive/core-types/fields <Type> SchemaObjectField#options',
  ],
};
