module.exports = {
  ...
  classes: [
    ...
    '(public) @ember-data/legacy-compat (Interface) Adapter',
    '(public) @warp-drive/core-types (Interface) Cache',
    '(public) @ember-data/legacy-compat (Interface) Serializer',
    ...
    '(public) @ember-data/store ReactiveDocument',
    '(public) @ember-data/store CacheKeyManager',
    ...
    '(public) @ember-data/store ResourceKey',
  ...
  classitems: [
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#camelize',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#capitalize',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#dasherize',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#setMaxLRUCacheSize',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#underscore',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#clear',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#clearRules',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#irregular',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#loadIrregular',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#loadUncountable',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#plural',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#pluralize',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#resetToDefaults',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#singular',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#singularize',
    '(public) @ember-data/request-utils/string @ember-data/request-utils/string#uncountable',
    ...
    '(public) @warp-drive/core-types (Type) LegacyResourceSchema#traits',
    '(public) @warp-drive/core-types (Type) LegacyResourceSchema#type',
    '(public) @warp-drive/core-types (Type) ObjectSchema#fields',
    '(public) @warp-drive/core-types (Type) ObjectSchema#identity',
    '(public) @warp-drive/core-types (Type) ObjectSchema#type',
    '(public) @warp-drive/core-types (Type) PolarisResourceSchema#fields',
    '(public) @warp-drive/core-types (Type) PolarisResourceSchema#identity',
    '(public) @warp-drive/core-types (Type) PolarisResourceSchema#traits',
    '(public) @warp-drive/core-types (Type) PolarisResourceSchema#type',
    '(public) @warp-drive/core-types (Type) GenericField#kind',
    '(public) @warp-drive/core-types (Type) GenericField#name',
    '(public) @warp-drive/core-types (Type) GenericField#options',
    '(public) @warp-drive/core-types (Type) GenericField#type',
    ...
    '(private) @ember-data/store CacheKeyManager#__configureMerge',
    '(private) @ember-data/store CacheKeyManager#_getRecordIdentifier',
    '(private) @ember-data/store CacheKeyManager#_mergeRecordIdentifiers',
    '(private) @ember-data/store CacheKeyManager#peekRecordIdentifier',
    ...
    '(public) @ember-data/legacy-compat (Interface) Adapter#coalesceFindRequests [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#createRecord',
    '(public) @ember-data/legacy-compat (Interface) Adapter#deleteRecord',
    '(public) @ember-data/legacy-compat (Interface) Adapter#destroy [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#findAll',
    '(public) @ember-data/legacy-compat (Interface) Adapter#findBelongsTo [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#findhasMany [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#findMany [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#findRecord',
    '(public) @ember-data/legacy-compat (Interface) Adapter#generateIdForRecord [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#groupRecordsForFindMany [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#query',
    '(public) @ember-data/legacy-compat (Interface) Adapter#queryRecord',
    '(public) @ember-data/legacy-compat (Interface) Adapter#shouldBackgroundReloadAll [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#shouldBackgroundReloadRecord [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#shouldReloadAll [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#shouldReloadRecord [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Adapter#updateRecord',
    '(public) @warp-drive/core-types (Interface) Cache#changedAttrs',
    '(public) @warp-drive/core-types (Interface) Cache#changedRelationships',
    '(public) @warp-drive/core-types (Interface) Cache#clientDidCreate',
    '(public) @warp-drive/core-types (Interface) Cache#commitWasRejected',
    '(public) @warp-drive/core-types (Interface) Cache#didCommit',
    '(public) @warp-drive/core-types (Interface) Cache#diff',
    '(public) @warp-drive/core-types (Interface) Cache#dump',
    '(public) @warp-drive/core-types (Interface) Cache#fork',
    '(public) @warp-drive/core-types (Interface) Cache#getAttr',
    '(public) @warp-drive/core-types (Interface) Cache#getRemoteAttr',
    '(public) @warp-drive/core-types (Interface) Cache#getErrors',
    '(public) @warp-drive/core-types (Interface) Cache#getRelationship',
    '(public) @warp-drive/core-types (Interface) Cache#hasChangedAttrs',
    '(public) @warp-drive/core-types (Interface) Cache#hasChangedRelationships',
    '(public) @warp-drive/core-types (Interface) Cache#hydrate',
    '(public) @warp-drive/core-types (Interface) Cache#isDeleted',
    '(public) @warp-drive/core-types (Interface) Cache#isDeletionCommitted',
    '(public) @warp-drive/core-types (Interface) Cache#isEmpty',
    '(public) @warp-drive/core-types (Interface) Cache#isNew',
    '(public) @warp-drive/core-types (Interface) Cache#merge',
    '(public) @warp-drive/core-types (Interface) Cache#mutate',
    '(public) @warp-drive/core-types (Interface) Cache#patch',
    '(public) @warp-drive/core-types (Interface) Cache#peek',
    '(public) @warp-drive/core-types (Interface) Cache#peekRequest',
    '(public) @warp-drive/core-types (Interface) Cache#put',
    '(public) @warp-drive/core-types (Interface) Cache#rollbackAttrs',
    '(public) @warp-drive/core-types (Interface) Cache#rollbackRelationships',
    '(public) @warp-drive/core-types (Interface) Cache#setAttr',
    '(public) @warp-drive/core-types (Interface) Cache#setIsDeleted',
    '(public) @warp-drive/core-types (Interface) Cache#unloadRecord',
    '(public) @warp-drive/core-types (Interface) Cache#upsert',
    '(public) @warp-drive/core-types (Interface) Cache#version',
    '(public) @warp-drive/core-types (Interface) Cache#willCommit',
    '(public) @ember-data/legacy-compat (Interface) Serializer#destroy [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Serializer#normalize [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Serializer#normalizeResponse',
    '(public) @ember-data/legacy-compat (Interface) Serializer#pushPayload [OPTIONAL]',
    '(public) @ember-data/legacy-compat (Interface) Serializer#serialize',
    '(public) @ember-data/legacy-compat (Interface) Serializer#serializeIntoHash [OPTIONAL]',
    ...
    '(public) @ember-data/json-api/request @ember-data/json-api/request#patchRecord',
    ...
    '(public) @ember-data/request-utils CachePolicy#didRequest',
    '(public) @ember-data/request-utils CachePolicy#invalidateRequest',
    ...
    '(public) @ember-data/store (Interface) CachePolicy#didRequest [Optional]',
    '(public) @ember-data/store (Interface) CachePolicy#isHardExpired',
    '(public) @ember-data/store (Interface) CachePolicy#isSoftExpired',
    '(public) @ember-data/store (Interface) CachePolicy#willRequest [Optional]',
    ...
    '(public) @ember-data/store CacheCapabilitiesManager#cacheKeyManager',
    ...
    '(public) @ember-data/store ReactiveDocument#data',
    '(public) @ember-data/store ReactiveDocument#errors',
    '(public) @ember-data/store ReactiveDocument#fetch',
    '(public) @ember-data/store ReactiveDocument#first',
    '(public) @ember-data/store ReactiveDocument#identifier',
    '(public) @ember-data/store ReactiveDocument#last',
    '(public) @ember-data/store ReactiveDocument#links',
    '(public) @ember-data/store ReactiveDocument#meta',
    '(public) @ember-data/store ReactiveDocument#next',
    '(public) @ember-data/store ReactiveDocument#prev',
    '(public) @ember-data/store ReactiveDocument#toJSON',
    '(public) @ember-data/store CacheKeyManager#createIdentifierForNewRecord',
    '(public) @ember-data/store CacheKeyManager#forgetRecordIdentifier',
    '(public) @ember-data/store CacheKeyManager#getOrCreateDocumentIdentifier',
    '(public) @ember-data/store CacheKeyManager#getOrCreateRecordIdentifier',
    '(public) @ember-data/store CacheKeyManager#updateRecordIdentifier',
    ...
    '(public) @ember-data/store ResourceKey#id',
    '(public) @ember-data/store ResourceKey#lid',
    '(public) @ember-data/store ResourceKey#type',
    ...
    '(public) @ember-data/store Store#cacheKeyManager',
    '(public) @ember-data/store Store#cacheKeyManager',
    ...
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_COMPUTED_CHAINS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_EMBER_INFLECTOR',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_LEGACY_IMPORTS',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_MANY_ARRAY_DUPLICATES',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_NON_STRICT_ID',
    '(public) @warp-drive/build-config CurrentDeprecations#DEPRECATE_NON_STRICT_TYPES',
    ...
    '(public) @warp-drive/build-config DebugLogging#LOG_GRAPH',
    '(public) @warp-drive/build-config DebugLogging#LOG_IDENTIFIERS',
    '(public) @warp-drive/build-config DebugLogging#LOG_INSTANCE_CACHE',
    '(public) @warp-drive/build-config DebugLogging#LOG_METRIC_COUNTS',
    '(public) @warp-drive/build-config DebugLogging#LOG_NOTIFICATIONS',
    ...
    '(public) @warp-drive/schema-record @warp-drive/schema-record#registerDerivations',
    '(public) @warp-drive/schema-record @warp-drive/schema-record#withDefaults',
    '(public) @warp-drive/core-types (Type) ArrayField#kind',
    '(public) @warp-drive/core-types (Type) ArrayField#name',
    '(public) @warp-drive/core-types (Type) ArrayField#type',
    '(public) @warp-drive/core-types (Type) CollectionField#kind',
    '(public) @warp-drive/core-types (Type) CollectionField#name',
    '(public) @warp-drive/core-types (Type) CollectionField#type',
    '(public) @warp-drive/core-types (Type) DerivedField#kind',
    '(public) @warp-drive/core-types (Type) DerivedField#name',
    '(public) @warp-drive/core-types (Type) DerivedField#type',
    '(public) @warp-drive/core-types (Type) HashField#kind',
    '(public) @warp-drive/core-types (Type) HashField#name',
    '(public) @warp-drive/core-types (Type) HashField#type',
    '(public) @warp-drive/core-types (Type) IdentityField#kind',
    '(public) @warp-drive/core-types (Type) IdentityField#name',
    '(public) @warp-drive/core-types (Type) LegacyAliasField#kind',
    '(public) @warp-drive/core-types (Type) LegacyAliasField#name',
    '(public) @warp-drive/core-types (Type) LegacyAliasField#type',
    '(public) @warp-drive/core-types (Type) LegacyAttributeField#kind',
    '(public) @warp-drive/core-types (Type) LegacyAttributeField#name',
    '(public) @warp-drive/core-types (Type) LegacyAttributeField#type',
    '(public) @warp-drive/core-types (Type) LegacyBelongsToField#kind',
    '(public) @warp-drive/core-types (Type) LegacyBelongsToField#name',
    '(public) @warp-drive/core-types (Type) LegacyBelongsToField#type',
    '(public) @warp-drive/core-types (Type) LegacyHasManyField#kind',
    '(public) @warp-drive/core-types (Type) LegacyHasManyField#name',
    '(public) @warp-drive/core-types (Type) LegacyHasManyField#type',
    '(public) @warp-drive/core-types (Type) LinksModeBelongsToField#kind',
    '(public) @warp-drive/core-types (Type) LinksModeBelongsToField#name',
    '(public) @warp-drive/core-types (Type) LinksModeBelongsToField#type',
    '(public) @warp-drive/core-types (Type) LinksModeHasManyField#kind',
    '(public) @warp-drive/core-types (Type) LinksModeHasManyField#name',
    '(public) @warp-drive/core-types (Type) LinksModeHasManyField#type',
    '(public) @warp-drive/core-types (Type) LocalField#kind',
    '(public) @warp-drive/core-types (Type) LocalField#name',
    '(public) @warp-drive/core-types (Type) LocalField#type',
    '(public) @warp-drive/core-types (Type) ObjectAliasField#kind',
    '(public) @warp-drive/core-types (Type) ObjectAliasField#name',
    '(public) @warp-drive/core-types (Type) ObjectAliasField#type',
    '(public) @warp-drive/core-types (Type) ObjectField#kind',
    '(public) @warp-drive/core-types (Type) ObjectField#name',
    '(public) @warp-drive/core-types (Type) ObjectField#type',
    '(public) @warp-drive/core-types (Type) PolarisAliasField#kind',
    '(public) @warp-drive/core-types (Type) PolarisAliasField#name',
    '(public) @warp-drive/core-types (Type) PolarisAliasField#type',
    '(public) @warp-drive/core-types (Type) ResourceField#kind',
    '(public) @warp-drive/core-types (Type) ResourceField#name',
    '(public) @warp-drive/core-types (Type) ResourceField#type',
    '(public) @warp-drive/core-types (Type) SchemaArrayField#kind',
    '(public) @warp-drive/core-types (Type) SchemaArrayField#name',
    '(public) @warp-drive/core-types (Type) SchemaArrayField#type',
    '(public) @warp-drive/core-types (Type) SchemaObjectField#kind',
    '(public) @warp-drive/core-types (Type) SchemaObjectField#name',
    '(public) @warp-drive/core-types (Type) SchemaObjectField#type',
    '(public) @warp-drive/core-types (Type) ArrayField#options',
    '(public) @warp-drive/core-types (Type) DerivedField#options',
    '(public) @warp-drive/core-types (Type) HashField#options',
    '(public) @warp-drive/core-types (Type) LegacyAliasField#options',
    '(public) @warp-drive/core-types (Type) LocalField#options',
    '(public) @warp-drive/core-types (Type) ObjectAliasField#options',
    '(public) @warp-drive/core-types (Type) ObjectField#options',
    '(public) @warp-drive/core-types (Type) PolarisAliasField#options',
