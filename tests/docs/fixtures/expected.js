module.exports = {
  ...
  classitems: [
    ...
    '(public) @ember-data/store RecordDataManager#peek',
    ...
    '(public) @ember-data/store RecordDataManager#clientDidCreate',
    '(public) @ember-data/store RecordDataManager#commitWasRejected',
    '(public) @ember-data/store RecordDataManager#didCommit',
    '(public) @ember-data/store RecordDataManager#getAttr',
    '(public) @ember-data/store RecordDataManager#getBelongsTo',
    '(public) @ember-data/store RecordDataManager#getErrors',
    '(public) @ember-data/store RecordDataManager#getHasMany',
    '(public) @ember-data/store RecordDataManager#getRelationship',
    '(public) @ember-data/store RecordDataManager#getResourceIdentifier',
    '(public) @ember-data/store RecordDataManager#hasChangedAttributes',
    '(public) @ember-data/store RecordDataManager#hasChangedAttrs',
    '(public) @ember-data/store RecordDataManager#isDeleted',
    '(public) @ember-data/store RecordDataManager#isDeletionCommitted',
    '(public) @ember-data/store RecordDataManager#isEmpty',
    '(public) @ember-data/store RecordDataManager#isNew',
    '(public) @ember-data/store RecordDataManager#pushData',
    '(public) @ember-data/store RecordDataManager#removeFromHasMany',
    ...
    '(public) @ember-data/store RecordDataStoreWrapper#attributesDefinitionFor',
    '(public) @ember-data/store RecordDataStoreWrapper#disconnectRecord',
    '(public) @ember-data/store RecordDataStoreWrapper#getSchemaDefinitionService',
    '(public) @ember-data/store RecordDataStoreWrapper#setRecordId',
    '(public) @ember-data/store RecordDataStoreWrapper#hasRecord',
    '(public) @ember-data/store RecordDataStoreWrapper#identifierCache',
    '(public) @ember-data/store RecordDataStoreWrapper#isRecordInUse',
    '(public) @ember-data/store RecordDataStoreWrapper#notifyBelongsToChange',
    '(public) @ember-data/store RecordDataStoreWrapper#notifyChange',
    '(public) @ember-data/store RecordDataStoreWrapper#notifyErrorsChange',
    '(public) @ember-data/store RecordDataStoreWrapper#notifyHasManyChange',
    '(public) @ember-data/store RecordDataStoreWrapper#notifyPropertyChange',
    '(public) @ember-data/store RecordDataStoreWrapper#notifyStateChange',
    '(public) @ember-data/store RecordDataStoreWrapper#recordDataFor',
    '(public) @ember-data/store RecordDataStoreWrapper#relationshipsDefinitionFor',
