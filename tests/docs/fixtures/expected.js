module.exports = {
  ...
  classes: [
    ...
    '(public) @ember-data/store ResourceCacheKey',
  ...
  classitems: [
    ...
    '(public) @ember-data/store IdentifierCache#getRequestCacheKey',
    ...
    '(public) @ember-data/store ResourceCacheKey#id',
    '(public) @ember-data/store ResourceCacheKey#lid',
    '(public) @ember-data/store ResourceCacheKey#type',
