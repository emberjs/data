...
module('integration-custom-model/adapter/build-url-mixin - BuildURLMixin with RESTAdapter', function(hooks) {
  setupTest(hooks);
  ...
  hooks.beforeEach(function() {
    ...
    */
    ...
    owner.register('model:post', CustomModel);
    owner.register('model:comment', CustomModel);
    owner.register('model:super-user', CustomModel);
