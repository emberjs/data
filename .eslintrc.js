  ...
  overrides: [
    ...
    // see https://github.com/emberjs/data/issues/6233#issuecomment-849279594
    {
      ...
      files: [
        ...
        'packages/private-build-infra/virtual-packages/deprecations.ts',
        'packages/private-build-infra/virtual-packages/current-deprecations.d.ts',
        'packages/private-build-infra/virtual-packages/available-packages.d.ts',
