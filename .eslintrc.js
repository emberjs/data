  ...
  overrides: [
    ...
    // see https://github.com/emberjs/data/issues/6233#issuecomment-849279594
    {
      ...
      files: [
        ...
        'tests/graph/tests/dummy/app/routes/application/route.ts',
        'tests/graph/tests/dummy/app/router.ts',
        'tests/graph/tests/dummy/app/resolver.ts',
        'tests/graph/tests/dummy/app/config/environment.d.ts',
        'tests/graph/tests/dummy/app/app.ts',
