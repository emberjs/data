...
import { ResourceIdentifierObject, NewResourceObject } from '../ts-interfaces/json-api';
import {
...
function defaultUpdateMethod(identifier: StableRecordIdentifier, data: ResourceIdentifierObject, bucket: string): void {}
...
export default class IdentifierCache {
  ...
  peekRecordIdentifier(resource: ResourceIdentifierObject, shouldGenerate: boolean = false): StableRecordIdentifier | null {
  ...
  */
  createIdentifierForNewRecord(data: NewResourceObject): StableRecordIdentifier {
