...
import type { Cache } from '@warp-drive/core/types/cache.ts';
...
export function preloadData(store: Store, identifier: StableNewRecordIdentifier, preload: Record<string, Value>) {
