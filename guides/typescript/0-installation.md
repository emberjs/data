...
-    "ember-data": "~5.3.3",
+    "ember-data": "5.4.0-alpha.59",
+    "@ember-data/store": "5.4.0-alpha.59",
+    "@ember-data/adapter": "5.4.0-alpha.59",
+    "@ember-data/graph": "5.4.0-alpha.59",
+    "@ember-data/json-api": "5.4.0-alpha.59",
+    "@ember-data/legacy-compat": "5.4.0-alpha.59",
+    "@ember-data/request": "5.4.0-alpha.59",
+    "@ember-data/request-utils": "5.4.0-alpha.59",
+    "@ember-data/serializer": "5.4.0-alpha.59",
+    "@ember-data/model": "5.4.0-alpha.59",
+    "@ember-data/tracking": "5.4.0-alpha.59",
...
-    "@types/ember__test": "4.0.6",
-    "@types/ember__utils": "4.0.7",
+    "@ember-data-types/adapter": "^5.4.0-alpha.59",
+    "@ember-data-types/model": "^5.4.0-alpha.59",
+    "@ember-data-types/serializer": "^5.4.0-alpha.59",
+    "@ember-data-types/store": "^5.4.0-alpha.59",
+    "@ember-data-types/graph": "^5.4.0-alpha.59",
+    "@ember-data-types/json-api": "^5.4.0-alpha.59",
+    "@ember-data-types/legacy-compat": "^5.4.0-alpha.59",
+    "@ember-data-types/request": "^5.4.0-alpha.59",
+    "@ember-data-types/request-utils": "^5.4.0-alpha.59",
+    "@ember-data-types/tracking": "^5.4.0-alpha.59",
+    "@warp-drive-types/core-types": "^0.0.0-alpha.45",
     "ember-data": "^4.12.7",
+    "ember-data-types": "^5.4.0-alpha.59",
```
